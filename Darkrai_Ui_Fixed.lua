...
function DarkraiX:Window(text,gamenme,logo,keybind)
	...
	Main:TweenSize(UDim2.new(0, 530, 0, 400),"Out","Quad",0.4,true)
	...
	BindButton.Position = UDim2.new(0.847561002, 0, 0, -5)
...
ScrollTab.Size = UDim2.new(0, 200, 0, 380)
...
MainPage.Size = UDim2.new(0, 350, 0, 300)
	...
	UserInputService.InputBegan:Connect(function(input)
		if input.KeyCode == Enum.KeyCode[yoo] then
			if uihide == false then
				...
				uihide = false
				Main:TweenSize(UDim2.new(0, 530, 0, 300),"Out","Quad",0.4,true)
			end
		end
	end)
...
function main:Toggle(text, config, callback)
    ...
    if config == true then
		...
		function main:Dropdown(text,option,callback)
			...
			DropImage.Position = UDim2.new(0, 215, 0, 6)
			...
			for i,v in next,option do
				...
				Item.MouseButton1Click:Connect(function()
					isdropping = false
					Dropdown:TweenSize(UDim2.new(0,270,0,31),"Out","Quad",0.3,true)
					TweenService:Create(
						DropImage,
						TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
						{Rotation = 180}
			...
			DropButton.MouseButton1Click:Connect(function()
				if isdropping == false then
					isdropping = true
					Dropdown:TweenSize(UDim2.new(0,270,0,131),"Out","Quad",0.3,true)
					TweenService:Create(
						DropImage,
						TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
						{Rotation = 0}
			...
			function dropfunc:Add(t)
				...
				Item.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				Item.BackgroundTransparency = 1.000
				Item.Size = UDim2.new(0, 278, 0, 26)
				Item.Font = Enum.Font.GothamSemibold
			...
			function dropfunc:Clear()
				...
				isdropping = false
				Dropdown:TweenSize(UDim2.new(0, 275, 0, 31),"Out","Quad",0.3,true)
				TweenService:Create(
					DropImage,
					TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
					{Rotation = 180}
		...
		function main:Slider(text,min,max,set,callback)
			...
			slidervalue.Position = UDim2.new(0, 209, 0, 5)
		...
		function main:Textbox(text,disappear,callback)
			...
			Textbox.Size = UDim2.new(0, 278, 0, 31)
			...
			Textboxx.Size = UDim2.new(0, 278, 0, 29)
			...
			TextboxLabel.Size = UDim2.new(0, 85, 0, 31)
			...
			txtbtn.Size = UDim2.new(0, 278, 0, 29)
			...
			RealTextbox.Size = UDim2.new(0, 80, 0, 24)
...
function main:Line()
			...
			Linee.Size = UDim2.new(0, 270, 0, 20)

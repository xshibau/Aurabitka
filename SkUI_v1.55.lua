...
function summitLib:CreateWindow(ConfigArgs)
	...
	ConfigArgs.Name = ConfigArgs.Name or "Unnamed Dinas UI Menu"
	...
	TemporaryText.Text = `<b>{ConfigArgs.Name}</b> x <b>Dinas UI Library v3 </b>`
	...
	function window:CreateNotification(args)
		...
		args.Description = args.Description or "UI recreate by Dinas. You forgot to put a description."
	...
	function window:CreateTab(tabConfig)
		...
		function thisTab:CreateToggle(args)
			...
			UICorner_2.CornerRadius = UDim.new(0)
	...
	window:CreateNotification({Title = "Dinas Library Example",Description = "Interface Successfully loaded.", Duration = 3})
	return window
end

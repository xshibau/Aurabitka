...
local uitab = {}
	...
	function uitab:Tab(text)
		...
		MainFramePage.Size = UDim2.new(0, 300, 0, 300)
	...
	local main = {}
		function main:Button(text,callback)
			...
			TextBtn.Size = UDim2.new(1, 0, 0, 29)
...
function main:Dropdown(text,option,callback)
			...
			Dropdown.Size = UDim2.new(1, 0, 0, 31)
			...
			DropTitle.Size = UDim2.new(1, 0, 0, 31)
	...
	function main:Slider(text,min,max,set,callback)
			...
			Slider.Size = UDim2.new(1, 0, 0, 51)
			...
			sliderr.Size = UDim2.new(1, 0, 0, 49)
	...
	function main:Textbox(text,disappear,callback)
			...
			Textbox.Size = UDim2.new(1, 0, 0, 31)

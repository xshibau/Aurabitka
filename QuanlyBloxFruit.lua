...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/Banana Hubroblox");
    end
});
...
if Sea3 then
    ...
    local v499 = v16.Sea:AddParagraph({
        Title = "Island Kitsune",
        Content = ""
    });
    function UpdateKitsune()
        if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
            v499:SetDesc("Island Spawn : ✅️");
        else
            v499:SetDesc("Island Spawn : ❌️");
        end
    end
...
local v93 = v16.Setting:AddSection("Setting Mastery");
...
local Main = v16.GeneralPlayer:AddSection("Teleport")
v16.GeneralPlayer:AddButton({
    Title = "Sea 1",
    Description = "",
    Callback = function()
...
local v125 = v16.GeneralFruit:AddToggle("TogglePermanentFruit", {
    Title = "Permanent Fruit Exchange",
    Description = "",
    Default = false
});
...
local Main = v16.GeneralFruit:AddSection("Raid Fruit")
local v136 = {
    "Flame",
    "Ice",
    "Quake",
...
local v144 = v16.Race:AddToggle("ToggleHumanandghoul", {
    Title = "Complete The Level [Human/Ghoul]",
    Description = "",
    Default = false
});

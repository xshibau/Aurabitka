...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=87467170005297";
v24.Parent = v23;
...
spawn(function()
    while task.wait() do
        if _G.AutoLevel then
            pcall(function()
                local oldQuest = NameQuest
                local oldMon = NameMon
                local oldPos = CFrameQ
                CheckLevel()
                if (NameQuest ~= oldQuest) or (NameMon ~= oldMon) or (CFrameQ ~= oldPos) then
                    Tween(CFrameQ)
                    repeat task.wait() until (game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameQ.Position).Magnitude <= 5)
                end
                        ...
                        if (v1433:FindFirstChild("Humanoid") and v1433:FindFirstChild("HumanoidRootPart") and (v1433.Humanoid.Health > 0)) then
                            if (v1433.Name == Ms) then
                                repeat
                                    ...
                                    Tween(v1433.HumanoidRootPart.CFrame * CFrame.new(0,15,0))
                    ...
                    for v1434, v1435 in pairs(game:GetService("Workspace")["_WorldOrigin"].EnemySpawns:GetChildren()) do
                        if string.find(v1435.Name, NameMon) then
                            if ((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v1435.Position).Magnitude >= 10) then
                                Tween(v1435.CFrame * CFrame.new(0,5,0))
                            end
                        end
                    end
                end
                    ...
                    if (v839:FindFirstChild("Humanoid") and v839:FindFirstChild("HumanoidRootPart") and (v839.Humanoid.Health > 0)) then
                        if v839.Name then
                            if ((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v839:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 5000) then
                                local targetHRP = v839.HumanoidRootPart
                                local farmPos = targetHRP.CFrame * CFrame.new(0,15,0) -- chỉnh offset lên đầu mob
                                Tween(farmPos)
                                repeat
                                    wait(_G.Fast_Delay);
                                    AttackNoCoolDown();
...
if Sea3 then
    local v503 = v16.Sea:AddSection("Sea Event");
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxthumb://87467170005297") then
                    return v729;
                end
            end
        end
...
local v77 = v16.ITM:AddToggle("ToggleAutoObservationV2", {
    Title = "Auto Haki Observation V2",
    Description = "",
    Default = false
});
...
local v102 = v16.GeneralPlayer:AddParagraph({
    Title = "Server Time",
    Content = ""
});
local function v103()
...
local v104 = v16.GeneralPlayer:AddParagraph({
...
local v105 = v16.GeneralPlayer:AddInput("Input", {
    Title = "Job ID",
    Default = "",
...
v16.GeneralPlayer:AddButton({
    Title = "Copy Job-id (Only Current Server)",
    Description = "",
    Callback = function()
        setclipboard(tostring(game.JobId));
    end
});
local v106 = v16.GeneralPlayer:AddToggle("MyToggle", {
...
local v108 = v16.GeneralPlayer:AddToggle("ToggleDe", {
    Title = "Auto Stats Defender",
    Description = "",
    Default = false
});
...
local v109 = v16.GeneralPlayer:AddToggle("ToggleSword", {
...
local v110 = v16.GeneralPlayer:AddToggle("ToggleGun", {
...
local v111 = v16.GeneralPlayer:AddToggle("ToggleFruit", {
...
local v113 = v16.GeneralPlayer:AddDropdown("SelectedPly", {
    Title = "Select Player",
    Description = "",
    Values = v112,
    Multi = false,
...
local v114 = v16.GeneralPlayer:AddToggle("ToggleTeleport", {
...
local v56 = v16.GeneralPlayer:AddSection("Local");
local v115 = v16.GeneralPlayer:AddToggle("ToggleNoClip", {
    Title = "Noclip",
    Description = "",
    Default = true
});
...
local v116 = v16.GeneralPlayer:AddToggle("ToggleWalkonWater", {
    Title = "Walkon Water",
    Description = "",
    Default = true
});
...
local v117 = v16.GeneralPlayer:AddToggle("ToggleEnablePvp", {
    Title = "Auto On PVP",
    Description = "",
    Default = false
});
...
local v118 = v16.GeneralPlayer:AddSection("World");
local v119 = v16.GeneralPlayer:AddToggle("ToggleAutoSea2", {
    Title = "Auto Sea 2",
    Description = "",
    Default = false
});
...
local v120 = v16.GeneralPlayer:AddToggle("ToggleAutoSea3", {
    Title = "Auto Sea 3",
    Description = "",
    Default = false
});
...
local v56 = v16.GeneralPlayer:AddSection("Island");
if Sea1 then
    IslandList = {
        "WindMill",
        "Marine",
...
local v121 = v16.GeneralPlayer:AddDropdown("DropdownIsland", {
    Title = "Select Island",
    Description = "",
    Values = IslandList,
    Multi = false,
...
v17.ToggleFruit:SetValue(false);
local v124 = v16.GeneralFruit:AddDropdown("DropdownPermanentFruit", {
...
local v125 = v16.GeneralFruit:AddToggle("TogglePermanentFruit", {
    Title = "Changed Permanent Fruit",
    Description = "",
    Default = false
});
...
local v126 = v16.GeneralFruit:AddToggle("ToggleStore", {
...
local v127 = v16.GeneralFruit:AddToggle("ToggleRandomFruit", {
    Title = "Random Fruits",
    Description = "",
    Default = false
});
...
local v128 = v16.GeneralFruit:AddToggle("ToggleCollectTP", {
...
local v129 = v16.GeneralFruit:AddToggle("ToggleCollect", {
...
local v56 = v16.GeneralFruit:AddSection("Esp");
local v130 = v16.GeneralFruit:AddToggle("ToggleEspPlayer", {
    Title = "Esp Player",
    Description = "",
    Default = false
});
...
local v131 = v16.GeneralFruit:AddToggle("ToggleEspFruit", {
    Title = "Esp Fruit",
    Description = "",
    Default = false
});
...
local v132 = v16.GeneralFruit:AddToggle("ToggleEspIsland", {
    Title = "Esp Island",
    Description = "",
    Default = false
});
...
local v133 = v16.GeneralFruit:AddToggle("ToggleEspFlower", {
    Title = "Esp Flower",
    Description = "",
    Default = false
});
...
local v134 = v16.GeneralFruit:AddToggle("ToggleEspRealFruit", {
    Title = "Esp Fruit Haki v2",
    Description = "",
    Default = false
});
...
local v135 = v16.GeneralFruit:AddToggle("ToggleIslandMirageEsp", {
...
local v56 = v16.GeneralFruit:AddSection("Raid");
local v136 = {
    "Flame",
    "Ice",
    "Quake",
...
local v137 = v16.GeneralFruit:AddDropdown("DropdownRaid", {
    Title = "Select Chip",
    Description = "",
    Values = v136,
    Multi = false,
...
local v138 = v16.GeneralFruit:AddToggle("ToggleBuy", {
    Title = "Buy Chip",
    Description = "",
    Default = false
});
...
local v139 = v16.GeneralFruit:AddToggle("ToggleStart", {
    Title = "Start Raid",
    Description = "",
    Default = false
});
...
local v140 = v16.GeneralFruit:AddToggle("ToggleNextIsland", {
...
local v141 = v16.GeneralFruit:AddToggle("ToggleAwake", {
    Title = "Auto Awake Fruits",
    Description = "",
    Default = false
});
...
local v142 = v16.GeneralFruit:AddToggle("ToggleGetFruit", {
    Title = "Auto Get Fruits",
    Description = "",
    Default = false
});
...
local v56 = v16.GeneralFruit:AddSection("Raid Law");
local v143 = v16.GeneralFruit:AddToggle("ToggleLaw", {
    Title = "Auto Farm Law",
    Description = "",
    Default = false
});
...
local v56 = v16.Race:AddSection("Farm");
...
v16.Shop:AddButton({
    Title = "Changed Race Draco",
    Description = "Only Sea 3",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5661.5322265625, 1013.0907592773438, - 334.9649963378906));
...
local v56 = v16.GeneralPlayer:AddSection("Misc")
v16.GeneralPlayer:AddButton({
    Title = "Join Server Again",
    Description = "",
    Callback = function()
...
local v56 = v16.GeneralPlayer:AddSection("Team");
v16.GeneralPlayer:AddButton({
    Title = "Mirage",
    Description = "",
    Callback = function()
...
local v56 = v16.GeneralPlayer:AddSection("Code");
local v150 = {
    "KITT_RESET",
    "Sub2UncleKizaru",
...
local v56 = v16.GeneralPlayer:AddSection("Title");
v16.GeneralPlayer:AddButton({
    Title = "Title",
    Description = "",
    Callback = function()
...
local v56 = v16.GeneralPlayer:AddSection("Awakeing");
v16.GeneralPlayer:AddButton({
    Title = "Awakeing",
    Description = "",
    Callback = function()
...
local v56 = v16.GeneralPlayer:AddSection("Misc");
local v151 = v16.GeneralPlayer:AddToggle("ToggleRejoin", {
    Title = "Join Server Again",
    Description = "",
    Default = true
});
...
local v56 = v16.GeneralPlayer:AddSection("Sương");
local function v152()
...
local v155 = v16.Sea:AddToggle("ToggleTPFrozenDimension", {
    Title = "Tween To Island Leviathan",
    Description = "",
    Default = false
});
...
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Tween To Door Trial Face Draco",
    Description = "",
    Default = false
});
